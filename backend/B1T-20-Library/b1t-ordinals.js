...
try {
    ...
    bitcore = require('bitcore-lib-xbt')
}
...
// Add B1T network to bitcore
bitcore.Networks.add('b1t', B1T_NETWORK);
bitcore.Networks.defaultNetwork = bitcore.Networks.b1t;
